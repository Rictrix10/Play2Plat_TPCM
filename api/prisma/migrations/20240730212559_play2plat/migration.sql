...
-- CreateIndex
CREATE UNIQUE INDEX "friendRequest_sentUserId_receivedUserId_key" ON "friendRequest"("sentUserId", "receivedUserId");
...
-- AddForeignKey
ALTER TABLE "friendRequest" ADD CONSTRAINT "friendRequest_sentUserId_fkey" FOREIGN KEY ("sentUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "friendRequest" ADD CONSTRAINT "friendRequest_receivedUserId_fkey" FOREIGN KEY ("receivedUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "message" ADD CONSTRAINT "message_userTwoId_fkey" FOREIGN KEY ("userTwoId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
